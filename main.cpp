...
//	Flight f1("Flight101", "FRANCE", "Canada", 50);
//	Flight f2("Flight102", "UAE", "USA", 40);
//	Flight f3("Flight103", "POLAND", "China", 30);
//
...
//	Sleep(3000);
	...
	while (!exit)
	{
		...
		if (val == 1)
		{
			...
			string flight;
			cout << endl;
			cout << "(Type 'N' if you don't want to book flight)" << endl;
		...
		{
			exit = true;
			cout << "Exiting from Airline Reservation System" << endl;
			Sleep(3000);
		}
		else
		{
